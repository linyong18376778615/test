...
public class fileUpload extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		// 获取文件需要上传到的路径
		String path="E:\\workspace\\ggdj\\WebRoot\\images";
		...
		*/
		...
		// byte[] a = item.getString().getBytes("utf-8");
		...
		*/
		...
		request.setAttribute("image2",filename1);
		}
		}
